...
<nav class="bg-slate-300 border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-50">
  ...
  <div class="hidden w-full md:block md:w-auto" id="navbar-default">
    ...
    <a href="{{url('/tugas-pendahuluan')}}" class="flex items-center">
        <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Tugas Pendahuluan 6</span>
    </a>
